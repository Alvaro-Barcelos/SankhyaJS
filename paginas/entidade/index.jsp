                ...
                /* Classe com as configuracoes de processamento de strings de internacionalizacao */
                    class Runner {
                        constructor (SkI18nService, SkWorkspace) {
                            ...
                            try {
                                MGEParameters.setParamValue('global.notifica.alteracao.dataset', 'false');
                                MGEParameters.setParamValue('br.com.sankhya.modelcore.validacaosegurancafiltros', false);
                            } catch (e) {
                                console.error(e);
                            }
